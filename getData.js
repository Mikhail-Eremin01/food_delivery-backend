...
const db = 'mongodb+srv://Michael:mixanya19972505@cluster0.mpenlh3.mongodb.net/food_delivery?retryWrites=true&w=majority';
...
const getData = async function(request, response, next){
    ...
    const kfc = await getRestaurantsInfo(Restaurant, "62fd0c4a1f3a671a69e62a13");
    const sharkys = await getRestaurantsInfo(Restaurant, "62fd0c4a1f3a671a69e62a14");
    const mcDonalds = await getRestaurantsInfo(Restaurant, "62fd0c4a1f3a671a69e62a15");
